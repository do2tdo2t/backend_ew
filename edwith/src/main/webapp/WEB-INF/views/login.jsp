...
<html lang="ko" class="no-js" >
   <head>
      ...
      <link rel="stylesheet" href="/edwith/css/bookinglogin.css">
   </head>
   <body class="biz  ko" >
         ...
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  ...
                  <!---->
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="/edwith/login/try" method="post" onsubmit="return checkEmail()">
                        ...
                        <button type="submit" form="form1" name="submit" class="login_btn confirm" > <span translate="CM-MY_BOOKING_CHECK">내 예약 확인</span> </button> <!----> <!----> <!----> <!----> 
                     </form>
                  </div>
                  <!----> <!----> 
               </div>
	...
	function checkEmail(){
		...
		var remail = document.querySelector("#resrv_id").value.replace(/ /g,"");
