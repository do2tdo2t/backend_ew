...
<body>
    <div id="container">
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    <a href="/edwith/api/products/${displayInfo.displayInfoId }" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        ...
                        <p class="dsc">
                           	${displayInfo.placeLot }(${displayInfo.placeStreet })  
                        </p>
                        ...
                        <p class="dsc">
                           	 성인(만 19~64세) <c:out value="${productPricesMap['A'].price }"/>원 / 청소년(만 13~18세) <c:out value="${productPricesMap['Y'].price  }"/>원<br> 어린이(만 4~12세) ${productPricesMap['B'].price  }원 / 20인 이상 단체 20% 할인<br> 국가유공자, 장애인, 65세 이상 4,000원
                        </p>
                    </div>
                </div>
                <div class="section_booking_ticket">
                <div class="ticket_body">
                <c:forEach var="price" items="${productPricesMap }" >
               		<div class="qty">
                            ...
                            <c:choose>
                            	...
                            	<c:when test="${price.value.priceTypeName == 'B' }">유아</c:when>
                            </c:choose> 
                            </span> </strong> 
                ...
                <div class="section_booking_form">
                    ...
                    <div class="section_booking_agreement">
                        ...
                        <div class="agreement"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span> </span>
                            <a href="javascript:whenClickShowAgreement(1)" class="btn_agreement"> <span class="btn_text">보기</span> <i class="fn fn-down2"></i> </a>
                        ...
                        <div class="agreement"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 제3자 제공 동의</span> </span>
                            <a href="javascript:whenClickShowAgreement(2)" class="btn_agreement"> <span class="btn_text">보기</span> <i class="fn fn-down2"></i> </a>
