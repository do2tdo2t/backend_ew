		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="/edwith/api/reservations/mypage" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
			...
			<form method="post" action="/edwith/api/reservations/${reservationInfoId }/comments" enctype="multipart/form-data">
				...
				<div class="review_contents write">
					...
					<a href="javascript:focusReviewArea()" class="review_write_info" >
						<span class="middot">
