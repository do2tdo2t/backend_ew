...
public class DisplayDaoSqls {
	...
	public static final String SELECT_DISPLAY_INFO_BY_ID = 
			...
			+ ", product_event, opening_hours, place_name, place_lot "
			...
			+ "where display_info.id = :displayInfoId ) as table1 " 
	...
	public static final String SELECT_DISPLAY_INFO_IMAGE_BY_ID = "select" + " content_type" + " ,create_date"
			...
			+ " on display_info_image.file_id = file_info.id " + " where display_info_id = :displayInfoId;";
